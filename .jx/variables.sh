...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-kube-client/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-kube-client:3.0.12'
